...
const CourseDetail = () => {
  ...
  // Additional scroll to top as backup
  useEffect(() => {
    window.scrollTo(0, 0);
  }, [courseId]);
    ...
    <Box sx={{ minHeight: '100vh', bgcolor: '#f9f9f9', py: 4 }}>
      <Container maxWidth="lg">
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                    ...
                    {/* First Row - Course Image, Info, and What You'll Learn */}
          <Card>
            <CardMedia
              component="img"
              sx={{ 
            ...
            <CardContent sx={{ p: 4 }}>
                ...
                {/* What You'll Learn - Horizontal Layout */}
                <Box sx={{ mt: 3, mb: 3 }}>
          ...
          {/* Second Row - Course Detail Article */}
          <Paper sx={{ p: 4 }}>
